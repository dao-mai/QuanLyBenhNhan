...
namespace QuanLyBenhNhan.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = "Data Source=localhost\\SQLEXPRESS;Initial Catalog=QuanLyBenhNhan;Integrated Security=True";
        ...
        {
            SqlDataAdapter adp = new SqlDataAdapter(sql, Functions.Conn);
